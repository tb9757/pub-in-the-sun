...
async function fetchVerdict(pub, cloudCover, sunAltitude, sunAzimuth) {
...
async function loadPubs(lat, lng) {
    ...
    try {
        ...
        for (const pub of pubs) {
            ...
            // Get cloud cover from our weather endpoint
            ...
            L.marker([pubLat, pubLng], { icon: marker })
                .addTo(map)
                .on('click', () => {
                    fetchVerdict(pub, cloudCover, sunAltitude, sunAzimuth);
                });
        }
